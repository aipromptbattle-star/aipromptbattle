...
export const CreepyButton = ({
    ...
    return (
        <button
            className={cn(
                "relative min-w-[9em] rounded-xl bg-transparent cursor-pointer outline-none select-none group tap-highlight-transparent",
        ...
        >
            ...
            <motion.span
                className={cn(
                    "absolute inset-0 block rounded-xl text-white font-bold tracking-wider",
                    "shadow-[inset_0_0_0_0.125em_rgba(0,0,0,0.08)]",
